...
namespace CAPA_DATOS
{
    ...
    {
        /*agrega el nombre de tu base de datos y el nombre de tu servidor*/
                                                                    //server        //base de datos
        private SqlConnection Conexion = new SqlConnection("Server=DESKTOP-BKCPHOT;DataBase=Consultame ;Integrated Security=true");
